...
- Include the execution command or verification evidence (an Allure report from `mobile-test-report` is good evidence)
...
- `pr-review-changes` — run first, to check Repo-contract compliance before describing/opening the PR
